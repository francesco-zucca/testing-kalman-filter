...
# The Stock & Watson model {#sec-one}
...
As illustrated in @fig-student-t, the Kalman filter remains consistent under student-t shocks, with factor recovery converging to approximately $0.7787$ as $T \rightarrow \infty$, in line with the Gaussian baseline from @sec-gaussian-dist.
...
### Skew-t with Increasing Skew {#sec-skew-t-increasing-skew}
...
## Efficiency Loss under Non-Gaussian Data
...
## Using Parallel Analysis to Determine the Number of Factors {#sec-one-factor-specification}
...
## Introducing More Indicators {#two-factor-specification}
