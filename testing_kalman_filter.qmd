...
We first replicate model proposed by Stock and Watson. Their model assumes that the comovements of four macroeconomic indicators are driven by a single, unobserved latent factor which represents the overall business cycle. The included indicators are:
...
Optimal parameters are estimated via Gaussian Maximum Likelihood.
...
#| label: fig-fit1
#| fig-cap: "Mapped Factor vs Actual GDP Quarterly Growth, Original Stock and Watson Model"
...
indicator_names <- c("IPMAN", "CMRMTSPL", "PAYEMS", "W875RX1",
